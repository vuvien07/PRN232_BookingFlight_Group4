...
function displayItems(items) {
            ...
            <tr>
                <td colspan="7" class="text-center py-5">
                    <div class="empty-state">
                        ...
                        <a href="/ItemManage/AddItem" class="btn btn-primary mt-2">
    ...
    tbody.innerHTML = items.map(item => `
        <tr class="fade-in">
            ...
            <td>
                <span class="fw-bold price">${formatPrice(item.price)}</span>
            </td>
            <td>
...
function displayPagination(pagination) {
    ...
    if (!pagination || pagination.totalPages <= 1) {
        ...
        if (resultsInfo && pagination) {
            resultsInfo.textContent = `Showing ${pagination.totalItems || 0} results`;
        }
        return;
    }
    ...
    if (resultsInfo) {
        ...
        resultsInfo.textContent = `Showing ${startItem}-${endItem} of ${totalItems} results`;
    }
